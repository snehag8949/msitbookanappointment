...
$teamno = $cname = $date  = $time = $status = $id = $specid = $specn = $comments = "";
$teamno_err = $cname_err = $date_err  = $time_err = $status_err = $id_err = $specid_err = $specn_err = $comments_err = "";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
   ...
   $input_teamno = trim($_POST["teamno"]);
    ...
    if(empty($input_specid)){
        $specid_err = "Please enter your specid";
    }  else{
        $specid = $input_specid;
    }
    ...
    if(empty($input_cname)){
        ...
        $cname_err = "Please enter a valid course name.";
    } else{
        $cname = $input_cname;
    }
   ...
   //Validate Roll number
    ...
    if(empty($teamno_err) && empty($specid_err) && empty($cname_err) && empty($date_err) && empty($time_err)){
...
<title>Bookings</title>
  ...
  $dp2.datepicker({
   ...
   <script>
$('input.date-time-picker').daterangepicker({
timePicker: true,
format: 'lll',
minDate: new Date(),
...
<!--Nav bar-->  
     <div class="wrapper">
        ...
        <div class="form-group <?php echo (!empty($specid_err)) ? 'has-error' : ''; ?>">
            ...
            <br>
            <select name="specid" value="<?php echo $specid; ?>"
                ...
                ?>
                <option value="<?php echo $specid["specid"]; ?>"><?php echo $specid["specid"]; ?></option>
                <?php
        ...
        <div class="form-group <?php echo (!empty($specn_err)) ? 'has-error' : ''; ?>">
            <label>Specialisation-Name</label><span style="color: red !important; display: inline; float: none;">*</span> <br /> <select name="specid"
    ...
    <div class="form-group <?php echo (!empty($cname_err)) ? 'has-error' : ''; ?>">
                    ...
                    <div class="form-group <?php echo (!empty($date_err)) ? 'has-error' : ''; ?>">
                             <label for="input.date-time-picker">Date</label><span style="color: red !important; display: inline; float: none;">*</span>      
                            <input type="text" name="date" class="form-control" id="input.date-time-picker" value="<?php echo $date; ?>">
